...
function displayEntriesFromObj(obj) {
    console.log('displayValuesFromObj()')

    for (const [key, value] of Object.entries(obj)) {\
        console.log(key, value)
    }
}
displayEntriesFromObj(obj)

// definition
function displayKeysFromObj(obj) {
    console.log('displayKeysFromObj()')
...
// execution
displayKeysFromObj(obj)


// definition
function displayValuesFromObj(obj) {
    console.log('displayValuesFromObj()')
